...
local FONT = gfx.font.new("fnt/moderndos")
local INVERTED_FONT = gfx.font.new("fnt/moderndos-inverted")
...
local portrait = nanoPortraitDialogueBox(TEXT, image, nil, FONT, INVERTED_FONT)
local dialogue = nanoDialogueBox(TEXT, FONT, INVERTED_FONT)
